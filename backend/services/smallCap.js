...
const smallCapFundData = [
    {
        "name": "Motilal Oswal Mutual Fund - Motilal Oswal MOSt Shares Midcap 100 ETF- Growth option",
        "scripcode": "536960"
    },
    {
...
const SmallCapMF = async (req, res) => {
    try {
        const promises = smallCapFundData.map(async (fund) => {
